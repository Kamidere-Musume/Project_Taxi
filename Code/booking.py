...
#class Dashboard(tk.Frame):
   ...
   # Start
      # Start Label 
      start_lbl = canvas.create_text(70,123, text="Current Location",fill="white",font=("Helvatica",12))
   ...
   # Destination 
      # Destination Label
      desti_lbl = canvas.create_text(650,123,text="Destination",fill="white", font=("Helvatica",12))
   ...
   # Date
      # Date Label
      date_lbl = canvas.create_text(70,200,text="Pick Up Date",fill="white", font=("Helvatica",12))
   ...
   # Distance Label
      distance_lbl = canvas.create_text(60,280,text="Distance",fill="white", font=("Helvatica",12))
      
      self.dis_lbl = Label(canvas,text="0 Km")
      self.dis_lbl.place(x=150,y=270,width=150)
           
   # Price Label
      price_lbl = canvas.create_text(630,280,text="Price",fill="white", font=("Helvatica",12))
      self.price_lbl = Label(canvas,text="Rs 0")
      self.price_lbl.place(x=700,y=270,width=150)
      
# Time
      # Time Label
      time_lbl = canvas.create_text(630,200,text="Pick Up Time",fill="white", font=("Helvatica",12))
